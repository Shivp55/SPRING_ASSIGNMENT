...
const navLinks = [
    ...
    //dropdown when admin is enabled
    { href: '#', iconClass: 'fa fa-fw fa-user', text: 'Add Customer', dropdownLinks: [
        { href: './add-user.html', text: 'Add Customer' },
        { href: './account.html', text: 'Add Account' }
    ] },
    // dropdown when user is 
